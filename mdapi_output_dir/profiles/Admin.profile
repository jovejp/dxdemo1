...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Test_Management</application>
    ...
    <fieldPermissions>
        ...
        <field>DailyTracker__c.Actual_Test_Cases__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>DailyTracker__c.Owner__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>DailyTracker__c.Plan_Test_Cases__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>DailyTracker__c.ReportDate__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>DailyTracker__c.TaskName__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>DailyTracker__c-DailyTracker Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>DailyTracker__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>DailyTracker__c</tab>
